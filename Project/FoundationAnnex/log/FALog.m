...
+ (void)debugDataLine:(const UInt8*)data count:(int)count inFunction:(const char*)function {
	...
	[FALog debug:line inFunction:function];
...
+(void)debugError:(NSError*)error withName:(const char*)name inFunction:(const char*)function {
    ...
    if( nil == error ) {
        ...
        [FALog debugForFunction:function format:@"%s = NULL", name];
        
    } else {
        
        [FALog debugForFunction:function format:@"[%s localizedDescription] = '%@'", name, [error localizedDescription]];
        [FALog debugForFunction:function format:@"[%s localizedFailureReason] = '%@'", name, [error localizedFailureReason]];
        [FALog debugForFunction:function format:@"[%s domain] = '%@'", name, [error domain]];
        [FALog debugForFunction:function format:@"[%s code] = '%d'", name, [error code]];
...
+(void)entered:(const char*)function {
	...
	[FALog debug:@"entered" inFunction:function];
...
+(void)warnError:(NSError*)error withName:(const char*)name inFunction:(const char*)function {
    ...
    if( nil == error ) {
        ...
        [FALog warnInFunction:function format:@"%s = NULL", name];
        
    } else {
        
        [FALog warnInFunction:function format:@"[%s localizedDescription] = '%@'", name, [error localizedDescription]];
        [FALog warnInFunction:function format:@"[%s localizedFailureReason] = '%@'", name, [error localizedFailureReason]];
        [FALog warnInFunction:function format:@"[%s domain] = '%@'", name, [error domain]];
        [FALog warnInFunction:function format:@"[%s code] = '%d'", name, [error code]];
...
+ (void)warnException:(NSException *)e withName:(const char*)name inFunction:(const char*)function {
    ...
    [FALog warnInFunction:function format:@"NSStringFromClass([%s class]) = '%@'", name, NSStringFromClass([e class])];
    [FALog warnInFunction:function format:@"[%s name] = '%@'", name, [e name]];
    [FALog warnInFunction:function format:@"[%s reason] = '%@'", name, [e reason]];
    
    [FALog warnInFunction:function format:@"[%s callStackSymbols] = [", name];
    ...
    for( NSString* callStackSymbol in callStackSymbols ) {
        ...
        [FALog warnInFunction:function format:@"\t%@", strackFrame];
    }
    [FALog warn:@"]" inFunction:function];
...
+(void)errorError:(NSError*)error withName:(const char*)name inFunction:(const char*)function {
    ...
    if( nil == error ) {
        [FALog errorInFunction:function format:@"%s = NULL", name];
    } else {
        
        [FALog errorInFunction:function format:@"[%s localizedDescription] = '%@'", name, [error localizedDescription]];
        [FALog errorInFunction:function format:@"[%s localizedFailureReason] = '%@'", name, [error localizedFailureReason]];
        [FALog errorInFunction:function format:@"[%s domain] = '%@'", name, [error domain]];
        [FALog errorInFunction:function format:@"[%s code] = '%d'", name, [error code]];
...
+ (void)errorException:(NSException *)e withName:(const char*)name inFunction:(const char*)function {
    ...
    [FALog errorInFunction:function format:@"NSStringFromClass([%s class]) = '%@'", name, NSStringFromClass([e class])];
    [FALog errorInFunction:function format:@"[%s name] = '%@'", name, [e name]];
    [FALog errorInFunction:function format:@"[%s reason] = '%@'", name, [e reason]];
    
    [FALog errorInFunction:function format:@"[%s callStackSymbols] = [", name];
    NSArray* callStackSymbols = [e callStackSymbols];
    for( NSString* callStackSymbol in callStackSymbols ) {
        NSString* strackFrame = [callStackSymbol stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        [FALog errorInFunction:function format:@"\t%@", strackFrame];
    }
    [FALog error:@"]" inFunction:function];
